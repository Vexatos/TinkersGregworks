 ...
 */
public class FryingPan extends tconstruct.items.tools.FryingPan implements ITGregElectricTool {
	...
	public boolean onLeftClickEntity(ItemStack stack, EntityPlayer player, Entity mob) {
		if(mob.canAttackWithItem() && !mob.hitByEntity(player) && mob.hurtResistantTime < 14) {
			TGregAbilityHelper.onLeftClickEntity(stack, player, mob, this);
		}
		return false;
	}
}
