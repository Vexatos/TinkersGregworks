 ...
 */
public class Scythe extends tconstruct.items.tools.Scythe implements ITGregElectricTool {
	...
	public boolean onLeftClickEntity(ItemStack stack, EntityPlayer player, Entity entity) {
		...
		for(Object o : list) {
			TGregAbilityHelper.onLeftClickEntity(stack, player, (Entity) o, this);
		}
		return true;
	}
}
