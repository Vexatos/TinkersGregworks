 ...
 */
public class Chisel extends tconstruct.items.tools.Chisel implements ITGregElectricTool {
	...
	public ItemStack getContainerItem(ItemStack itemStack) {
		if(itemStack.hasTagCompound()) {
			...
			if(random.nextInt(10) < 10 - reinforced) {
				TGregAbilityHelper.damageTool(itemStack, 1, null, false);
			}
		}
		return itemStack;
	}
	...
	public ItemStack onEaten(ItemStack itemstack, World world, EntityPlayer entityplayer) {
		if(!world.isRemote) {
			...
			if(movingobjectposition.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK) {
				...
				Detailing.DetailInput details = TConstruct.chiselDetailing.getDetailing(block, meta);
				if(details != null) {
