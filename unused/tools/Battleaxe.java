 ...
 */
public class Battleaxe extends tconstruct.items.tools.Battleaxe implements ITGregElectricTool {

	@Override
	public boolean onBlockDestroyed(ItemStack itemstack, World world, Block b, int x, int y, int z, EntityLivingBase player) {
		return !(b != null && b.getMaterial() == Material.leaves)
			&& TGregAbilityHelper.onBlockChanged(itemstack, world, b, x, y, z, player, random);
