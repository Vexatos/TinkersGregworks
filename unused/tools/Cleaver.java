 ...
 */
public class Cleaver extends tconstruct.items.tools.Cleaver implements ITGregElectricTool {
	...
	public boolean onLeftClickEntity(ItemStack stack, EntityPlayer player, Entity entity) {
		if(TGregAbilityHelper.onLeftClickEntity(stack, player, entity, this)) {
